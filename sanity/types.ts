...
// Query: *[_type == "startup" && defined(slug.current) &&   (!defined($search) || $search == "" || title match $search || category match $search || author->name match $search)]   | order(_createdAt desc) {    _id,     title,     slug,    _createdAt,    author -> {      _id, name, image, bio    },     views,    description,    category,    image,}
...
export type STARTUPS_BY_AUTHORResult = Array<{
  _id: string;
  title: string | null;
  slug: Slug | null;
  _createdAt: string;
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[_type == \"author\" && id == $id ][0]{ \n  _id,\n  id,\n  name,\n  username,\n  email,\n  image,\n  bio}": AUTHOR_BY_GITHUB_IDResult;
    "*[_type == \"author\" && _id == $id ][0]{ \n  _id,\n  id,\n  name,\n  username,\n  email,\n  image,\n  bio}": AUTHOR_BY_IDResult;
